...
| 2026-04-11 | Phase 10-D (feat/signup-telemetry): Signup funnel anomaly detection | Client-side telemetry collects scroll events, form fill timing, input corrections. link_click_at passed via URL param from /ref/[code]. Trust penalties: fast signup (<10s) -40, no scroll -20, fast form fill (<5s) -30, no corrections -15. Soft signals only — never blocks signup. | migration 20260411000001, signup/page.tsx, signup/actions.ts, ref/[code]/route.ts, auth/callback/route.ts |
